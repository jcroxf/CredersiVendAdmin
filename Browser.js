...
/**
     * Convienience method for retrieving headless element by TagName
     */
    async getElementByTag(tag) {
        const selector = webdriver.By.tagName(tag);
        return await this.headless.findElement(selector);
    }
    ...
    async getAttribute(attributeName) {
        const selector = webdriver.By.attributeName(attributeName);
        return await this.headless.findElement(selector);
    }
}
